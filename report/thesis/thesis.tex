...
Note that the only distinction between SCP and CrossVal-CP is how the calibration set is constructed. Since it does not place any additional restriction for the choices of the underlying surrogate, Cross-Val can be applied in conjunction with either ensemble predictor or quantile regressor. See Section \ref{sec:scp} for detailed configurations.
