...
\begin{description}[leftmargin=0cm]
	...
	Now, take a closer look at the formula \ref{math:gaussianinterval} and recall the example based on the absolute residuals, which is presented earlier in this section. We observe that the derived confidence interval under the Gaussian assumption takes exactly the same form as the prediction interval produced by CP when the conformity scoring function is chosen as:
		\begin{equation}
