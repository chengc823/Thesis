...
\begin{figure}[H]
	...
	\parbox{\linewidth}{
	\vspace{0.5em}
	{\small \textit{Figure \ref{fig: b2_gaussian_acq_search_strategy}}: \gls{rmsce} (top) and validation accuracy (bottom) for BANANAS using various acquisition optimization strategies. All methods take 10 initial evaluations and use ITS as acquisition function. 
	}}
}	
\end{figure}	 	
...
\begin{figure}[H]
	...
	\parbox{\linewidth}{
	\vspace{0.5em}
	{\small \textit{Figure \ref{fig: b2_gaussian_arch_mutate}}: \gls{rmsce} (top) and validation accuracy (bottom) for BANANAS employing a mutation strategy that mutates different numbers of architectures. All methods take 10 initial evaluations and use ITS as acquisition function. 
...
\begin{figure}[H]
	...
	\parbox{\linewidth}{
	\vspace{0.5em}
	{\small \textit{Figure \ref{fig: b2_cvcp}}: \gls{rmsce} (top) and validation accuracy (bottom) for CrossVal-CP ensemble based methods employing different acquisition optimization strategies. All methods take 10 initial evaluations and use a 3-fold cross-validation.
	}}
}	
\end{figure}
...
\begin{figure}[H]
	...
	\parbox{\linewidth}{
	\vspace{0.5em}
	{\small \textit{Figure \ref{fig: b2_scp_quantile}}: \gls{rmsce} (top) and validation accuracy (bottom) for SCP-Quantile methods that use different acquisition functions. Both methods take 10 initial evaluations and employ a quantile regressor trained on 10 quantile levels, with a train-calibration splitting rate of 0.5.
	}}
}	
\end{figure}
...
\begin{figure}[H]
	...
	\parbox{\linewidth}{
	\vspace{0.5em}
	{\small \textit{Figure \ref{fig: b3_bootstrap_5}}: \gls{rmsce} (top) and validation accuracy (bottom) for \gls{btcp} methods that have 5 bootstraps and use different conformity score functions. Both methods take 10 initial evaluations and employ an ensemble predictor.	}}
}	
\end{figure}
...
\begin{figure}[H]
	...
	\parbox{\linewidth}{
	\vspace{0.5em}
	{\small \textit{Figure \ref{fig: b3_bootstrap_10}}: \gls{rmsce} (top) and validation accuracy (bottom) for \gls{btcp} methods that have 10 bootstraps and use different conformity score functions. Both methods take 10 initial evaluations and employ an ensemble predictor.	}}
}	
\end{figure}
